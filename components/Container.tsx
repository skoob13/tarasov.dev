...
export default function Container({ children, image, ...customMeta }: Props) {
  ...
  return (
    <div className="container max-w-2xl mx-auto min-h-screen flex flex-col">
      ...
      <nav className="sticky-nav flex justify-between items-center p-4 md:my-8 bg-white dark:bg-black bg-opacity-60">
        ...
        <ul className="flex gap-4 sm:gap-1 items-center">
          ...
          <button
            type="button"
            className="sm:ml-3 w-9 h-9 bg-gray-200 rounded-lg dark:bg-gray-600 flex items-center justify-center hover:ring-2 ring-gray-300 transition-all"
          ...
          <li>
            <ExternalLink href="https://twitter.com/anottoday" className="flex items-center">
              ...
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                className="fill-gray-900 dark:fill-gray-100 w-4 h-4"
              >
